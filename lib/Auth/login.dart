  ...
  // }
   ...
   void goToLink(user_type_id, user_id) async {
      switch (user_type_id){
        ...
        case 2:
          ...
          break;
        case 3:
          final url = Uri.parse('http://68.178.163.174:5008/doctors/check_approved?user_id=${user_id}');
   ...
   void handleSubmit() async {
     ...
     final phoneRegex = RegExp(r'^\d{11}$');
        ...
        final url = Uri.parse('http://68.178.163.174:5008/users/login?email=${x ? '1': '0'}');
