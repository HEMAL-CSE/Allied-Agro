...
import 'package:alliedagro/components/ClickButton.dart';
...
class _SignupState extends State<Signup> {
  ...
  //   final url = Uri.parse('http://68.178.163.174:5008/users/register');
  //
  ...
  //
  //   final url2 = Uri.parse('http://68.178.163.174:5008/farm/add');
  //
  //
  ...
  Future<void> handleDoctorSubmit() async {
    ...
    //     .then((value) async {
      ...
      if(res.statusCode == 201){
        ...
        final url2 = Uri.parse('http://68.178.163.174:5008/doctors/add');
