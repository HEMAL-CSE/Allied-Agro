...
class DairyLabour extends StatefulWidget {
  const DairyLabour({super.key});

  @override
  State<DairyLabour> createState() => _DairyLabourState();
}

class _DairyLabourState extends State<DairyLabour> {
  String? shed_id;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Dairy Labour',),
      body: ListView(
        children: [
          SizedBox(height: 04,),
          ...
          Container(
              ...
              child: CustomTextField(controller: name, hintText: "Name", obscureText: false, textinputtypephone: true)),
