...
class BioGasCustomer extends StatefulWidget {
  const BioGasCustomer({super.key});

  @override
  State<BioGasCustomer> createState() => _BioGasCustomerState();
}

class _BioGasCustomerState extends State<BioGasCustomer> {
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5008/biogas/customer/add');
    Map body = {
  ...
  void editData(id) async {
    final url = Uri.parse('http://68.178.163.174:5008/biogas/customer/edit?id=${id}');
    Map body = {
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5008/biogas/customer/delete?id=${id}');
