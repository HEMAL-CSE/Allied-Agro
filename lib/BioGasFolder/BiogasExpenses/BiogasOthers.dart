...
class BiogasOthers extends StatefulWidget {
  const BiogasOthers({super.key});

  @override
  State<BiogasOthers> createState() => _BiogasOthersState();
}

class _BiogasOthersState extends State<BiogasOthers> {
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5008/biogas/others/add');
    Map body = {
      'name': name.text,
    };
  ...
  void editData(id) async {
    final url = Uri.parse('http://68.178.163.174:5008/biogas/others/edit?id=${id}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5008/biogas/others/delete?id=${id}');
      ...
      body: ListView(
        children: [
          ...
          Container(
              ...
              child: CustomTextField(controller: name, hintText: "নাম", obscureText: false, textinputtypephone: false)),
