...
class _DoctorDairyTreatmentState extends State<DoctorDairyTreatment> {
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5008/doctors/dairy/cow?user_id=${user_id}&cow_id=${widget.cow_id}');
  ...
  void handleSubmit() async {
    ...
    String? user_id = prefs.getString('user_id');
    final url = Uri.parse('http://68.178.163.174:5008/doctors/dairy/treatment?doctor_id=${user_id}');
