...
class _DoctorDuckTreatmentState extends State<DoctorDuckTreatment> {
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5008/doctors/duck/duck?user_id=${user_id}&phase_number=${widget.duck_id}');
  ...
  void handleSubmit() async {
    ...
    String? user_id = prefs.getString('user_id');
    final url = Uri.parse('http://68.178.163.174:5008/doctors/duck/treatment?doctor_id=${user_id}');
