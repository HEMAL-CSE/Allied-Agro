...
class _DoctorBeefTreatmentState extends State<DoctorBeefTreatment> {
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5008/doctors/beef/cattle?user_id=${user_id}&cattle_id=${widget.cattle_id}');
  ...
  void handleSubmit() async {
    ...
    String? user_id = prefs.getString('user_id');
    final url = Uri.parse('http://68.178.163.174:5008/doctors/beef/treatment?doctor_id=${user_id}');
