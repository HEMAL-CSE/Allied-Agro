...
class _BeefFatteningTreatmentDescState extends State<BeefFatteningTreatmentDesc> {
    ...
    for(var i in doctors) {
      if (i['selected'] == true) {
        ...
        MultipartRequest request = MultipartRequest(
            'POST', Uri.parse('http://68.178.163.174:5008/cattles/treatment'));
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5008/doctors/beef?farm_id=${farm_id}');
  ...
  void deleteData(cattle_id, doctor_id) async {
    final url = Uri.parse('http://68.178.163.174:5008/cattles/treatment/delete?cattle_id=${cattle_id}&doctor_id=${doctor_id}');
