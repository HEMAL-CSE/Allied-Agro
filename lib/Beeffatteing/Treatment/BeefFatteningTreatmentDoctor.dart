...
class BeefFatteningTreatmentDoctor extends StatefulWidget {
  const BeefFatteningTreatmentDoctor({super.key});

  @override
  State<BeefFatteningTreatmentDoctor> createState() => _BeefFatteningTreatmentDoctorState();
}

class _BeefFatteningTreatmentDoctorState extends State<BeefFatteningTreatmentDoctor> {
  String? doctor_id;
