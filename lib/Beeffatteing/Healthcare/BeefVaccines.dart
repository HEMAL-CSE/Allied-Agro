...
class BeefVaccines extends StatefulWidget {
  const BeefVaccines({super.key});

  @override
  State<BeefVaccines> createState() => _BeefVaccinesState();
}

class _BeefVaccinesState extends State<BeefVaccines> {
