...
class BeefProfitReport extends StatefulWidget {
  const BeefProfitReport({super.key});

  @override
  State<BeefProfitReport> createState() => _BeefProfitReportState();
}

class _BeefProfitReportState extends State<BeefProfitReport> {
