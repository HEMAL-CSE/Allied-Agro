...
class _VermiCompostExpensesReportState extends State<VermiCompostExpensesReport> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/report/expenses/cowdung?start_date=${startDate.toIso8601String()}&end_date=${endDate.toIso8601String()}');
    Response res = await get(url);

    var data = jsonDecode(res.body);

    print(data);
    final url2 = Uri.parse('http://68.178.163.174:5008/vermi_compost/report/expenses/labour?start_date=${startDate.toIso8601String()}&end_date=${endDate.toIso8601String()}');
    ...
    final url3 = Uri.parse('http://68.178.163.174:5008/vermi_compost/report/expenses/others?start_date=${startDate.toIso8601String()}&end_date=${endDate.toIso8601String()}');
  ...
  void getLabourDetails() async {
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/report/expenses/labour/filter?start_date=${startDate.toIso8601String()}&end_date=${endDate.toIso8601String()}');
    Response res = await get(url);
  ...
  void getOthersDetails() async {
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/report/expenses/others/filter?start_date=${startDate.toIso8601String()}&end_date=${endDate.toIso8601String()}');
    Response res = await get(url);
