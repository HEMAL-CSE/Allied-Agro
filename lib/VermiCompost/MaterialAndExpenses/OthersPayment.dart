...
class OthersPayment extends StatefulWidget {
  const OthersPayment({super.key});

  @override
  State<OthersPayment> createState() => _OthersPaymentState();
}

class _OthersPaymentState extends State<OthersPayment> {
  ...
  void getOthers() async {
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/others_list');
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/others_payment');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/others_payment/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/others_payment/edit?id=${editid.text}');
  ...
  void deleteData(id) async{
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/others_payment/delete?id=${id}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'অন্যান্য খরচসমূহের পেমেন্ট',),
          ...
          child: InputDecorator(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                    ...
                    isExpanded: true,
                    menuMaxHeight: 350,
                    hint: Text('খরচ সিলেক্ট করুন'),
                    items: [
                      ...othersList.map<DropdownMenuItem<String>>((data) {
                      ...
                      Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text('অন্যান্য খরচ আইডি : ${i['others_id']}', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                            ),
                            Padding(
                              padding: EdgeInsets.symmetric(horizontal: 15.0, vertical: 5),
                              child: Text('পেমেন্ট: ${i['amount']} BDT', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w800),),
                            ),
                            Padding(
                              padding: EdgeInsets.symmetric(horizontal: 15.0, vertical: 5),
                            ...
                            GestureDetector(
                              onTap: () {
                                setState(() {
                                  ...
                                  editothers = i['others_id'].toString();
