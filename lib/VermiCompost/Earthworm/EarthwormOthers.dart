...
class EarthwormOthers extends StatefulWidget {
  const EarthwormOthers({super.key});

  @override
  State<EarthwormOthers> createState() => _EarthwormOthersState();
}

class _EarthwormOthersState extends State<EarthwormOthers> {
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/earthworm_others/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/earthworm_others/edit?id=${editid.text}');
  ...
  void deleteData(id) async{
    final url = Uri.parse('http://68.178.163.174:5008/vermi_compost/earthworm_others/delete?id=${id}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: CustomAppBar(title: ' Others Expenses List',), //Appbar
