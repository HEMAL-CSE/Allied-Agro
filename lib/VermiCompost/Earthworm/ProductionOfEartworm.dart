...
class ProductionEarthWorm extends StatefulWidget {
  const ProductionEarthWorm({Key? key}) : super(key: key);

  @override
  State<ProductionEarthWorm> createState() => _State();
}

class _State extends State<ProductionEarthWorm> {
  ...
  Widget build(BuildContext context) {
    return
      Scaffold(
          appBar: CustomAppBar(title: 'Production Details',), //Appbar
      ...
      Container(
          ...
          child: CustomTextField(controller: kg, hintText: "kg", obscureText: false, textinputtypephone: true)),
