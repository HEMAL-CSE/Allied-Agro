...
class EarthwormOthersPayment extends StatefulWidget {
  const EarthwormOthersPayment({super.key});

  @override
  State<EarthwormOthersPayment> createState() => _EarthwormOthersPaymentState();
}

class _EarthwormOthersPaymentState extends State<EarthwormOthersPayment> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Others Expenses Payment',),
