...
class _EarthwormPurchaseState extends State<EarthwormPurchase> {
  ...
  void getSellerList() async {
    final url = Uri.parse('http://68.178.163.174:5007/vermi_compost/earthworm_seller');
  ...
  void getData() async{
    final url = Uri.parse('http://68.178.163.174:5007/vermi_compost/earthworm_purchase');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5007/vermi_compost/earthworm_purchase/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5007/vermi_compost/earthworm_purchase/edit?id=${editid.text}');
  ...
  void deleteData(id) async{
    final url = Uri.parse('http://68.178.163.174:5007/vermi_compost/earthworm_purchase/delete?id=${id}');
