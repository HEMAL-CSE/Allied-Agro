...
class EarthwormLabourPayment extends StatefulWidget {
  const EarthwormLabourPayment({super.key});

  @override
  State<EarthwormLabourPayment> createState() => _EarthwormLabourPaymentState();
}

class _EarthwormLabourPaymentState extends State<EarthwormLabourPayment> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5007/vermi_compost/earthworm_labour_payment');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5007/vermi_compost/earthworm_labour_payment/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5007/vermi_compost/earthworm_labour_payment/edit?id=${editid.text}');
  ...
  void deleteData(id) async{
    final url = Uri.parse('http://68.178.163.174:5007/vermi_compost/earthworm_labour_payment/delete?id=${id}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Labour/Supervisor Payment',),
      body: ListView(children: [
          ...
          child: InputDecorator(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                    ...
                    isExpanded: true,
                    menuMaxHeight: 350,
                    hint: Text('Select Labour/Supervisor'),
                    items: [
        ...
        Container(
            ...
            child: CustomTextField(controller: amount, hintText: "Amount BDT", obscureText: false, textinputtypephone: true)),
