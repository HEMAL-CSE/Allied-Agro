...
class _EarthwormComponentState extends State<EarthwormComponent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: ' Materials of EathWorm',), //Appbar
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Sells', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 19),),
                            SizedBox(height: 10,),
                            Container(
                                padding: EdgeInsets.all(10),
                                decoration: BoxDecoration(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Environment', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
                            SizedBox(height: 10,),
                            Container(
                                padding: EdgeInsets.all(10),
                                decoration: BoxDecoration(
