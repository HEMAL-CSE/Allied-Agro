...
class CowHealthcare extends StatelessWidget {
  const CowHealthcare({super.key});
        ...
        slivers: [
          SliverGrid.count(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  Navigator.pushNamed(context, '/cowVaccines');
                },
                child: Card(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.pushNamed(context, '/cowMedicine');
                },
                child: Card(
                  color: Colors.greenAccent[400],
                  elevation: 5,
