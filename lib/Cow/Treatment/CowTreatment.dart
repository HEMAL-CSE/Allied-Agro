...
class BreedingTreatment extends StatefulWidget {
  const BreedingTreatment({super.key});

  @override
  State<BreedingTreatment> createState() => _BreedingTreatmentState();
}

class _BreedingTreatmentState extends State<BreedingTreatment> {
          ...
          for(var i in data)
            Card(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Text('গাভী নাম্বার: ${i[i.keys.toList()[0]][0]['cow_id']}', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
